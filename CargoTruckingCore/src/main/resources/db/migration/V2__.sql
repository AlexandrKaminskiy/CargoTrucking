ALTER TABLE users
    ADD CONSTRAINT FK_USERS_ON_CLIENT FOREIGN KEY (client_id) REFERENCES client (id);

ALTER TABLE storage
DROP
CONSTRAINT fk5nr54tlnftmej6ujxnl4xoxxh;
...
DROP
CONSTRAINT fknvrppuxmve5e45loau5eyxr3d;

ALTER TABLE users_client
DROP
CONSTRAINT fks0s6mmc4yacve9p1lf32nwx3b;

DROP TABLE users_client CASCADE;
